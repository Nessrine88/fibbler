...
const articles = [
  {
    ...
    link: "/docs/tech-doc",
    author: {
      name: "Adam Hartsner, CTO",
      avatar: "/assets/img/adamhartsner.jpeg",
    },
  },
  {
    type: "How to, Salesforce",
    publishedDate: "2023-08-28", // Example published date
    title: "Guide for those who prefer to create custom fields in Salesforce",
    description:
      "While our platform can automatically create custom fields for you, this guide is for those who prefer to manually set up fields in Salesforce to track LinkedIn ads metrics like impressions, clicks, and engagements.",
    link: "/docs/custom-fields-salesforce",
    author: {
      name: "Adam Hartsner, CTO",
      avatar: "/assets/img/adamhartsner.jpeg",
    },
