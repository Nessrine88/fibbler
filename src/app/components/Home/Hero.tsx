  ...
  return (
    <section className="xl:mt-[149px] sm:mt-[79px] mt-[48px]  ">
      <div className="container">
        ...
        {data?.page1[0].title ?? "Identify"}{" "}
          <span className=" bg-[url('/assets/img/line-shape-1.svg')] bg-no-repeat bg-bottom bg-contain">
            {data?.page1[0].heighlightedText ?? "influenced deals"}
          </span>{" "}
          {data?.page1[0].subtitle ??"from your LinkedIn Ads impression data"}
        </h1>
        <p className="text-[#181127] text-center sm:leading-[31px] leading-[146%] font-[500] sm:text-[22px] text-[16px] max-w-[634px] mx-auto satoshifont-500 xl:mb-[80px] md:mb-[77px] mb-[48px] px-[20px] sm:px-[0]">
          {data?.page1[0].description ?? "Fibbler helps you understand how LinkedIn Ads impressions influence your pipeline and revenue, while turning engagement data into actionable intent signals for your ABM program."}
        </p>
        <div className="flex justify-center ">
          ...
          >
            <span className="block  whitespace-nowrap">
              {data?.page1[0].button ??"Try 30 days for free"}
            </span>
            <WhiteRightArrow />
          </Link>
        </div>
